...
import "descriptor_tile.widget.dart";
...
class CharacteristicTileWidget extends StatefulWidget {
  ...
  @override
  State<CharacteristicTileWidget> createState() => _CharacteristicTileState();
}

class _CharacteristicTileState extends State<CharacteristicTileWidget> {
  List<int> _value = [];
