...
class DescriptorTileWidget extends StatefulWidget {
  final BluetoothDescriptor descriptor;

  const DescriptorTileWidget({super.key, required this.descriptor});

  @override
  State<DescriptorTileWidget> createState() => _DescriptorTileState();
}

class _DescriptorTileState extends State<DescriptorTileWidget> {
  List<int> _value = [];
  ...
  Widget buildReadButton(BuildContext context) {
    return TextButton(onPressed: onReadPressed, child: const Text("Read"));
  }

  Widget buildWriteButton(BuildContext context) {
    return TextButton(onPressed: onWritePressed, child: const Text("Write"));
  }
